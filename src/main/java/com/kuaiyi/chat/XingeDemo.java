...
// 易用接口
//		System.out.println(XingeApp.pushTokenAndroid(accessId, secretKey, "test", "测试", "token"));
//		System.out.println(XingeApp.pushAccountAndroid(accessId, secretKey, "test", "测试", "15856985122"));
